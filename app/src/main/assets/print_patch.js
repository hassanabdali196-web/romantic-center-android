(function(){
  ...
  window.openOrderDetails = function(id){
    ...
    if(o && has('update_orders')) modalBody.insertAdjacentHTML('beforeend',`<button class="btn gold" style="width:100%;margin-top:12px" onclick="printInvoice('${o.id}')">🖨 طباعة الفاتورة / حفظ PDF</button>`);
  };
})();
